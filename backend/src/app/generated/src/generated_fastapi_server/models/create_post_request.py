...
class CreatePostRequest(BaseModel):
    ...
    excerpt: Optional[StrictStr] = Field(default=None, description="Short summary or excerpt of the blog post")
    status: Optional[StrictStr] = Field(default=None, description="Status of the blog post")
    __properties: ClassVar[List[str]] = ["title", "content", "excerpt", "status"]
