...
class CommentsResponse(BaseModel):
    ...
    data: List[Comment] = Field(description="Array of comments for the blog post")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CommentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CommentsResponse from a dict"""
        if obj is None:
            return None
