...
class BlogPostListResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BlogPostListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BlogPostListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": BlogPostListData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
