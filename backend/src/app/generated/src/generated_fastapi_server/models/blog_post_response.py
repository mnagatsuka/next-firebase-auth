...
class BlogPostResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BlogPostResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BlogPostResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": BlogPost.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
