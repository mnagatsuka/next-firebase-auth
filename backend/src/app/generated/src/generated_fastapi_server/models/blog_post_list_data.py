...
class BlogPostListData(BaseModel):
    ...
    BlogPostListData
    """ # noqa: E501
    posts: Optional[List[BlogPostSummary]] = Field(default=None, description="Array of blog post summaries")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BlogPostListData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BlogPostListData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "posts": [BlogPostSummary.from_dict(_item) for _item in obj.get("posts")] if obj.get("posts") is not None else None,
