...
class PostApplicationService:
    ...
    async def create_post(self, title: str, content: str, excerpt: str, author: str) -> dict:
        ...
        try:
            ...
            return {
                ...
                "pagination": {
                    "page": page,
                    "limit": limit,
                    "total": len(post_summaries)  # This is simplified; real implementation would count total
                }
            }
        except Exception as e:
