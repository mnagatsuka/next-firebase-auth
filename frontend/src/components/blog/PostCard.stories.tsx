...
export const LongTitle: Story = {
	args: {
		id: "2",
		title:
			"A Very Long Blog Post Title That Might Wrap to Multiple Lines and Should Be Handled Gracefully",
		excerpt:
			"This post has a very long title to test how the card handles text overflow and wrapping.",
		author: "Jane Smith",
...
export const LongExcerpt: Story = {
	args: {
		...
		title: "Short Title",
		excerpt:
			"This is a very long excerpt that should be truncated with line-clamp. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.",
		author: "Bob Johnson",
