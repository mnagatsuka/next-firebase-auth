 ...
 */
export type PromoteAnonymousRequestLang = typeof PromoteAnonymousRequestLang[keyof typeof PromoteAnonymousRequestLang];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PromoteAnonymousRequestLang = {
  en: 'en',
  ja: 'ja',
} as const;
